...
namespace Netflex.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Movie movie, List<IFormFile> files)
        {
            if (ModelState.IsValid)
            {
                ...
                if (files != null)
                {
                    ...
                    movie.VideoUrl = fileUrl;
                    movie.PostedAt = DateTime.Now;
                    _context.Add(movie);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Title,PostedAt")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
